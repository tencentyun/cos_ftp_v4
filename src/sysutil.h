...
int vsf_sysutil_exist_access(const char* p_filename);
...
int vsf_sysutil_lock_file_write_addi(int fd);
int vsf_sysutil_unlock_file_addi(int fd);
...
const char* vsf_sysutil_int_to_str(int the_int);
