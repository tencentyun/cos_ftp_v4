...
extern const char* tunable_cos_appid;
extern const char* tunable_cos_secretid;
extern const char* tunable_cos_secretkey;
extern const char* tunable_cos_bucket;
extern const char* tunable_cos_region;
extern const char* tunable_cos_download_domain;
extern const char* tunable_user_home_dir;

extern const char* tunable_login_users;

extern unsigned int tunable_cos_conn_timeout_ms;
extern unsigned int tunable_cos_req_timeout_ms;
extern unsigned int tunable_cos_sign_expire_s;
extern unsigned int tunable_cos_upload_slice_size;
extern int tunable_cos_take_sha;

extern unsigned int tunable_max_upload_file_size;
extern unsigned int tunable_list_max_count;
extern unsigned int tunable_cos_download_chunk_size;
#endif
