...
#if 1 //modify 20160908
  { "cos_take_sha", &tunable_cos_take_sha },
#endif
  { 0, 0 }
};
...
parseconf_uint_array[] =
{
  ...
  { "max_upload_file_size", &tunable_max_upload_file_size },
  { "list_max_count", &tunable_list_max_count },
  { "cos_download_chunk_size", &tunable_cos_download_chunk_size },
  { "cos_upload_slice_size", &tunable_cos_upload_slice_size },
  { "cos_conn_timeout_ms", &tunable_cos_conn_timeout_ms },
  { "cos_req_timeout_ms", &tunable_cos_req_timeout_ms },
  { "cos_sign_expire_s", &tunable_cos_sign_expire_s },
#endif
  { 0, 0 }
};
...
#if 1 //modify 20160901
  { "cos_appid", &tunable_cos_appid },
  { "cos_secretid", &tunable_cos_secretid },
  { "cos_secretkey", &tunable_cos_secretkey },
  { "cos_bucket", &tunable_cos_bucket },
  { "cos_region", &tunable_cos_region },
  { "cos_download_domain", &tunable_cos_download_domain },
  { "cos_user_home_dir", &tunable_user_home_dir },
  { "login_users", &tunable_login_users },
#endif
  { 0, 0 }
};
